...
{
    public class PartnershipRequestedState : PartnershipState 
    {
        ...
        public PartnershipRequestedState(PartnershipStateInfo info)
        {
