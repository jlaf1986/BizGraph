...
{
    public class AllianceMembershipRejectedState: AllianceMembershipState 
    {

        private OrganizationAccount _requestorOrganization = null;
        private Alliance _requestedAlliance = null;
        private DateTime _submitDateTime = DateTime.Now;
        private IAllianceMembershipRepository _repository;

        public AllianceMembershipRejectedState(OrganizationAccount thisPerson, IAllianceMembershipRepository repository)
        {
        ...
        {
            return AllianceMembershipAction.Reject;
        }
